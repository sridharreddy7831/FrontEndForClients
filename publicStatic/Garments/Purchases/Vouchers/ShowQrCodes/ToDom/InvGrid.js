...
let LocalTotalFunc = ({ inData }) => {
    let jVarLocalInvArrayNeeded = Object.values(inData).map(element => element.Qty);
    ...
    let jVarLocalInvArrayAmount = Object.values(inData).map(element => element.Amount);
    ...
    let jVarLocalInvArrayRate = Object.values(inData).map(element => element.UnitRate);
    ...
    let jVarLocalInvArrayMRP = Object.values(inData).map(element => element.MRP);
